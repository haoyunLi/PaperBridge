...
async function run() {
  ...
  try {
    ...
    await page.locator('.onboarding[data-onboarding-page="0"]').waitFor();
    ...
    console.log('Packaged Windows executable opened the first-launch guide, automatic setup and the Reader successfully.');
